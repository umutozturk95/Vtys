       ...
       if($c2 = OCILogon("C##b21328394", "21328394", $db2))
          {
		    ...
		    $array=oci_parse($c2,"insert into blog_tag values(DEFAULT,'$title')");		
            oci_execute($array);
			$array=oci_parse($c2,"insert into logUser values(DEFAULT,'$person_id','Blog etiketi ekliyor.',to_date('$delivDate','dd-mm-yy hh24:mi:ss'))");		
            oci_execute($array);	
		 }  
	  oci_close($c2);
   ...
   <body  style="background-color:powderblue; !important;">  
    ...
    <div id="menu">
       ...
       <?php			
		    ...
		    $array3=oci_parse($c,"select blog_tag_id,tag_name from blog_tag");
	         oci_execute($array3);
				   ...
				   <?php
					...
					?>	
				     <tr>
                       ...
                       <td><a href="blogEtiketGuncelle.php?etiket_id=<?php echo $row3[0];?>">Güncelle</a></td>
