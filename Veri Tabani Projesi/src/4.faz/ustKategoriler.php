       ...
       if($c2 = OCILogon("C##b21328394", "21328394", $db2))
          {
		    ...
		    $array=oci_parse($c2,"insert into blog_topcategory values(DEFAULT,'$title','$sira')");		
            oci_execute($array);
		    
		
			$array=oci_parse($c2,"insert into logUser values(DEFAULT,'$person_id','Blog ust kategori ekliyor.',to_date('$delivDate','dd-mm-yy hh24:mi:ss'))");		
            oci_execute($array); 
		 }  
	  oci_close($c2);
				   ...
				   <?php
					...
					?>	
				     <tr>
                       ...
                       <td><a href="ustKategoriGuncelle.php?kategori_id=<?php echo $row3[0];?>">Güncelle</a></td>
